...
const dstate[index]?.variants&&state[index]?.variants.length>0 &&state[index]?.variants.filter((item)=>item?.id!==id)
  return (
    <li>
      <div className="innerDv">
        ...
        <div className="btnBox">
          <div className="inputBoxCs">
            ...
            <input type="text" className="form-control" />
            <a href="#" onClick={() => handleVariantDelete(item?.id, productIndex)}>
              ❌
            </a>
          </div>
        </div>
