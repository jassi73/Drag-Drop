...
const NewOne = ({ provided, index, item, setData, variants }) => {
  ...
  const onDragEnd = (params, index) => {
    ...
    console.log("params", srcI, desI, params, index);
    variantState.splice(desI, 0, state.splice(srcI, 1)[0]);
  };
  console.log("varinat state", variantState);
  const onDelete = (id) => {
  ...
  return (
    <DragDropContext key={9} onDragEnd={(e) => onDragEnd(e, index)}>
